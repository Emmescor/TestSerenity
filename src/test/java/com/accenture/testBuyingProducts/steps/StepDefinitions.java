...
//    	while (celdas.containsKey(i)) {
//			String items = celdas.get(0).get(i);
//			johnDoe.LookUpForProducts(items);
//            johnDoe.AddProductToShoppingCart();
//            johnDoe.ClearSearchTextBox();
//			i++;
...
//    	Cell celda;
//    	celda = celdas.next();
//    	while (celda.getStringCellValue() != null) {
//    		String items = celda.getStringCellValue();
//    		johnDoe.LookUpForProducts(items);
//            johnDoe.AddProductToShoppingCart();
//            celda = celdas.next();
//		}
